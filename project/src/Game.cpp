...
void Game::render() {
  ...
  // GLfloat lightColor[4] = {10.f, 10.f, 10.f, 1.0f};

  // // Luce del sole
  // {
  //   float direction[4] = {0.0f, 0.0f, 0.0f, 1.f}; // ultima comp=0 => luce direzionale
  ...
  junkManager.renderSecretTech(*this);
